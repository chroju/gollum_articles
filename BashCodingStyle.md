...
* [続・ラフなラボ – シェルスクリプトが '> $logfile 2>&1' だらけにならなくて済んだ話](https://memo.laughk.org/2014/04/24/shell_exec_log.html)
  * `exec`コマンドで「以降の標準出力をファイルxxにリダイレクトする」設定が可能。
* [シェルスクリプトのロギングを楽にするtips - Qiita](http://qiita.com/Ets/items/cd3baa5cecbf553f822d)
  * `tee`でログファイルにも標準出力にも出すスタイル。とてもいい！感じ。
